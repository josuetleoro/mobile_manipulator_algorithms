function [dP,w,dPa,wa]=manGradJ(q,J)
%Calculates the manipulability of the system and the arm using J of the MM
%for all the calculations. The arm part is extracted as the submatrix of J
