...
dP(1,1)=0;
dP(2,1)=w_2*trace(inv_JJt*(dJdq3*Jt+J*dJdq3'));
dP(3,1)=0;
dP(4,1)=w_2*trace(inv_JJt*(dJdq5*Jt+J*dJdq5'));
dP(5,1)=w_2*trace(inv_JJt*(dJdq6*Jt+J*dJdq6'));
dP(6,1)=w_2*trace(inv_JJt*(dJdq7*Jt+J*dJdq7'));
dP(7,1)=w_2*trace(inv_JJt*(dJdq8*Jt+J*dJdq8'));
dP(8,1)=w_2*trace(inv_JJt*(dJdq9*Jt+J*dJdq9'));
dP(9,1)=0;
% w_2
% dP
...
dPa(1,1)=0;
dPa(2,1)=wa_2*trace(inv_JaJat*(dJadq3*Jat+Ja*dJadq3'));
dPa(3,1)=0;
dPa(4,1)=wa_2*trace(inv_JaJat*(dJadq5*Jat+Ja*dJadq5'));
dPa(5,1)=wa_2*trace(inv_JaJat*(dJadq6*Jat+Ja*dJadq6'));
dPa(6,1)=wa_2*trace(inv_JaJat*(dJadq7*Jat+Ja*dJadq7'));
dPa(7,1)=wa_2*trace(inv_JaJat*(dJadq8*Jat+Ja*dJadq8'));
dPa(8,1)=wa_2*trace(inv_JaJat*(dJadq9*Jat+Ja*dJadq9'));
dPa(9,1)=0;
% UR5_w_2
% UR5_dP
% pause()
