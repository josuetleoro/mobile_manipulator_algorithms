classdef MARS_UR5
    ...
    properties
        ...
        a = -0.079;
        b = 0.0762 + 0.480 + 0.110; %(wheels radius + center of wheels to prism joint + safety distance for ur5)
    ...
    methods
        ...
        function obj=MARS_UR5()
            %Direction and Points of each joint
            obj.p1=[obj.a+obj.l1;0;obj.b];
            obj.p2=[obj.a+obj.l1;0;obj.b];
            obj.p3=[obj.a+obj.l1;0;obj.b-obj.l2];
            obj.p4=[obj.a+obj.l1;0;obj.b-obj.l2-obj.l3];
            obj.p5=[obj.a+obj.l1;obj.l4;obj.b-obj.l2-obj.l3];
            obj.p6=[obj.a+obj.l1-obj.l5;obj.l4+obj.l6;obj.b-obj.l2-obj.l3];
%             obj.p1=[obj.a;0;obj.l1];
%             obj.p2=[obj.a;0;obj.l1];
%             obj.p3=[obj.a-obj.l2;0;obj.l1];
%             obj.p4=[obj.a-obj.l2-obj.l3;0;obj.l1];
%             obj.p5=[obj.a-obj.l2-obj.l3;-obj.l4;obj.l1];
%             obj.p6=[obj.a-obj.l2-obj.l3;-obj.l4;obj.l1-obj.l5];
            
            %Auxiliar line for tool position and Normal Direction
            obj.d7=[1;0;0]; obj.p7=obj.p6;
            %Auxiliar axis for tool orientation
        ...
        function T0e=forwardKin(this,q)
            ...
            %qL8=DualQuat(Quat(0,this.d8),Quat(0,this.m8));
            
            %Get the new positions and orientations of L7 and L8
            newQL6=Q*qL6*Qc;
            newQL7=Q*qL7*Qc;
            
            %Get the intersections of L7 and L8
