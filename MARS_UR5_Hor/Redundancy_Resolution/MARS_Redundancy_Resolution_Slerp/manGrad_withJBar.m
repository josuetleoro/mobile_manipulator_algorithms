function [dP,w,UR5_dP,UR5_w]=manGrad_withJBar(q,J)
...
dP(1,1)=0;
dP(2,1)=w_2*trace(inv_JJt*dJJtdq3_ev);
dP(3,1)=0;
dP(4,1)=w_2*trace(inv_JJt*dJJtdq5_ev);
dP(5,1)=w_2*trace(inv_JJt*dJJtdq6_ev);
dP(6,1)=w_2*trace(inv_JJt*dJJtdq7_ev);
dP(7,1)=w_2*trace(inv_JJt*dJJtdq8_ev);
dP(8,1)=w_2*trace(inv_JJt*dJJtdq9_ev);
dP(9,1)=0;
...
UR5_dP(2,1)=0;
UR5_dP(3,1)=0;
UR5_dP(4,1)=UR5_w_2*trace(UR5_inv_JJt*dJJtdq5_ev);
UR5_dP(5,1)=UR5_w_2*trace(UR5_inv_JJt*dJJtdq6_ev);
UR5_dP(6,1)=UR5_w_2*trace(UR5_inv_JJt*dJJtdq7_ev);
UR5_dP(7,1)=UR5_w_2*trace(UR5_inv_JJt*dJJtdq8_ev);
UR5_dP(8,1)=UR5_w_2*trace(UR5_inv_JJt*dJJtdq9_ev);
UR5_dP(9,1)=0;
